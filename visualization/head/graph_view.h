...
public slots:
    ...
    void vexRemoved(MyGraphicsVexItem *vex)
    {
        vexes.erase(vexes.begin() + vexes.indexOf(vex));
        vexNum--;
    }
    void arcRemoved(MyGraphicsLineItem *line)
    {
...
class MyGraphicsVexItem : public QObject, public QGraphicsEllipseItem //点
{
    Q_OBJECT
...
private:
    ...
    QString nameText = "";
    QFont nameFont = QFont("Times", 13, QFont::Normal, true);
    QGraphicsSimpleTextItem *tag = nullptr;
    QString hintText = "";
    QFont hintFont = QFont("Times", 12);
...
class MyGraphicsLineItem : public QObject, public QGraphicsLineItem //线
{
    Q_OBJECT
