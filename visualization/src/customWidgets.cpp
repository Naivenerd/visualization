...
void customIcon::changeIcon(QString iconPath)
{
    QSvgRenderer renderer;
    renderer.load(iconPath);
    QSize size = renderer.defaultSize();
...
void customIcon::setDefaultColor(const QColor &newDefaultColor)
{
...
void customIcon::setHoverColor(const QColor &newHoverColor)
{
